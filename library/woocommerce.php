...
add_action( 'woocommerce_shop_loop_item_title', 'boatprofi_template_loop_product_title', 10);
function boatprofi_template_loop_product_title(){
	echo '<p>Зарядное устройство Dual Pro Professional SS1 220 В</p>';
}

add_action( 'woocommerce_after_shop_loop_item_title', 'boatprofi_template_loop_price', 10 );
function boatprofi_template_loop_price(){
	echo '<p><span class="sirvices-item-costs">106600 руб.</span></p>';
}

remove_action( 'woocommerce_after_shop_loop_item', 'boatprofi_template_loop_add_to_cart', 10 );
function boatprofi_template_loop_add_to_cart() {
