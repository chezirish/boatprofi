<?php
/*
Template Name: Пример Страница услуги
*/
        ...
        <div class="single-service-page__right-content cell medium-12 large-9">
            ...
            <div class="single-service-page__info-wrapper clearfix">
                ...
                <div class=" single-service-page__info-desc float-right">
                    ...
                    <img src="<?= get_template_directory_uri() ?>/dist/assets/images/single-service5.jpg" alt="boat">
                </div>
            </div>
            ...
            <div class="single-service-page__info-wrapper clearfix">
                ...
                <div class="single-service-page__project float-left">
                    <h3>Проект</h3>
                    <p>26 февраля</p>
                    <img src="<?= get_template_directory_uri() ?>/dist/assets/images/boat7.jpg" alt="boat">
                    <p class="single-service-page__projec-text">Монтаж навигационного  и музыкального оборудования</p>
                    <a href="">Подробнее</a>
                </div>
            </div>
